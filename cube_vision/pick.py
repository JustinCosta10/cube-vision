"""Pick-by-color workflow: see a colored cube, move the closest arm to grab it."""
...
from cube_vision.visualize import save_ik_plot, visualize_color_detection


def run_pick_by_color(color: str | None = None) -> None:
    color = color or DEFAULT_DETECT_COLOR
